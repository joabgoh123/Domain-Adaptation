...
def train_src(encoder, classifier, data_loader, DEVICE):
    ...
    for epoch in range(params.num_epochs_pre):
        ...
        if ((epoch + 1) % params.eval_step_pre == 0):
            eval_src(encoder, classifier, data_loader, DEVICE)
    ...
    # # save final model
    torch.save(encoder.state_dict(), 'src_encoder.pth')
    torch.save(classifier.state_dict(), 'src_classifier.pth')
